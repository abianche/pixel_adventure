...
class Chicken extends SpriteAnimationGroupComponent with HasGameRef<PixelAdventure>, CollisionCallbacks {
  ...
  double targetDirection = -1; // default face left
  ...
  void _movement(double dt) {
    ...
    double playerOffset = (player.scale.x > 0) ? 0 : -player.width; // consider width when facing left
    double chickenOffset = (scale.x > 0) ? 0 : -width; // consider width when facing left
  ...
  bool playerInRange() {
    ...
    return player.x + playerOffset >= rangeNeg &&
        ...
        player.y + player.height >= position.y && // bottom of player above top of chicken
  ...
  void collidedWithPlayer() async {
    // player is falling and the bottom of player is greater than top of chicken
